...
async function validatePublicUrl(rawUrl, lookup = dns.lookup) {
  let url;
  try { url = new URL(normalizeUrlInput(rawUrl)); } catch { throw new Error('Informe uma URL válida.'); }
...
module.exports = { isPrivateIp, normalizeUrlInput, validatePublicUrl, sameOrigin };
